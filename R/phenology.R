#' @title PINUS CONTORTA VAR LATIFOLIA FLOWERING PHENOLOGY
#' @description Phenology of pollen shed and cone receptivity in lodgepole pine. Years cover 1997-2011. Data was collected at seven sites with multiple provenances represented at (most) sites. All sites were British Columbia seed orchard locations. There are multiple orchards at each site. Each orchard has trees whose seeds were sourced from a specific seed planning unit (as defined by the ministry in British Columbia.)
#' @format A data frame with 36182 rows and 16 variables:
#' \describe{
